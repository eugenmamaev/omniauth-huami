...
module OmniAuth
  module Strategies
    ...
    class Huami < OmniAuth::Strategies::OAuth2

      option :client_options, {
          :site          => 'https://user.HuaMi.com',
          :authorize_url => 'https://user.HuaMi.com/oauth/index.html#/',
          :token_url     => 'https://auth.huami.com/oauth2/access_token',
          :token_method  => :post
      }
...
OmniAuth.config.add_camelization 'huami', 'Huami'
